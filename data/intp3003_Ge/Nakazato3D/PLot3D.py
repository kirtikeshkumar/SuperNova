...
############################################################################
files = os.listdir("./data/intp3003_Ge/")

f = pd.read_csv("data/intp3003_Ge/"+files[0],delimiter='\t',header=None)
...
##    print(file_name,'\t',lowtime,hitime,'\t',lowE,hiE,'\t',loTIndex,hiTIndex,'\t',histname[0])
    ...
    f = pd.read_csv("data/intp3003_Ge/"+file_name,delimiter='\t',header=None)
    shp = f.shape
